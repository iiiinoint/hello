...
class NetworkInterface {
  private:
	...
	std::map<uint32_t, std::pair<EthernetAddress, size_t>> _ipaddr_ethernetaddr_memtime_map{};
	std::map<uint32_t, size_t> _ipaddr_arptime_map{};
	std::deque<std::pair<uint32_t, InternetDatagram>> _waiting_queue{};
	size_t _curr_time{0};
  public:
